...
class ProgramCrawler extends BaseCrawler implements CrawlerInterface
{
    ...
    public function crawl(array $response, string $date, int $stadiumId, int $raceNumber): array
    {
        ...
        if (is_null($deadline)) {
            ...
            $datetime = $date . ' ' . $deadline;
            $closedAt = Converter::convertToDateTime($datetime);
        }
     ...
     * @return array
     */
    protected function explodeNational123Percentages(?string $national123Percentages): array
    {
     ...
     * @return array
     */
    protected function explodeLocal123Percentages(?string $local123Percentages): array
    {
     ...
     * @return array
     */
    protected function explodeMotorNumberMotor23Percentages(?string $motorNumberMotor23Percentages): array
    {
     ...
     * @return array
     */
    protected function explodeBoatNumberBoat23Percentages(?string $boatNumberBoat23Percentages): array
    {
