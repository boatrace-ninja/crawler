...
class ProgramCrawler extends BaseCrawler implements CrawlerInterface
{
    ...
    public function crawl(array $response, Carbon $date, int $stadiumId, int $raceNumber): array
    {
        ...
        $closedAt = $this->assembleClosedAt($date, $deadline);
     ...
     * @return array
     */
    protected function explodeSubtitleDistance(?string $subtitleDistance): array
    {
     ...
     * @return array
     */
    protected function explodeNumberClassName(?string $numberClassName): array
    {
     ...
     * @return array
     */
    protected function explodeBranchNameBirthplaceNameAgeWeight(?string $branchNameBirthplaceNameAgeWeight): array
    {
     ...
     * @return array
     */
    protected function explodeFlyingCountLateCountStartTiming(?string $flyingCountLateCountStartTiming): array
    {
     ...
     * @return array
     */
    protected function explodeNational123Percent(?string $national123Percent): array
    {
     ...
     * @return array
     */
    protected function explodeLocal123Percent(?string $local123Percent): array
    {
     ...
     * @return array
     */
    protected function explodeMotorNumberMotor23Percent(?string $motorNumberMotor23Percent): array
    {
     ...
     * @return array
     */
    protected function explodeBoatNumberBoat23Percent(?string $boatNumberBoat23Percent): array
    {
     ...
     * @return string|null
     */
    protected function assembleClosedAt(Carbon $date, ?string $deadline): ?string
    {
        if (is_null($deadline)) {
            return null;
        }

        return $date->setTimeFromTimeString($deadline)->format('Y-m-d H:i:s');
    }
}
